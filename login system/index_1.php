  ...
  <li><img src="img/8.jpg" /></li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <a href="meal plan.php" class="btn">Meal plan and Calories</a>
          <p><h4>We Provide What You need to Be better than Before.<h4><a class="btn btn-default" href="meal plan.php" role="button" id="c2">View details &raquo;</a></p>
        </div>
      </div>
